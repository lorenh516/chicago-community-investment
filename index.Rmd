...
ggplot(waffle_data, aes(x, y, fill = group)) + 
  ...
  theme_waffle() 
```
With the upcoming election for Chicago City Council, we can only hope that the city's residents utilize their right to choose leaders who will work to build a more equitable Chicago.
