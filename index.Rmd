...
```{r facet_wrap_demo_info, message=FALSE, warning=FALSE, fig.width=20, fig.height=25}
...
ggplot(st_intersection(all_demos.Chi, wards.2015) %>% filter(!is.na(predominant_race))) +
  ...
  theme(plot.margin = unit(c(20, 0, 0, 0), "pt"),
        plot.title = element_text(size = 30, face = "bold", hjust="0.5", margin = margin(t = 15)),
        plot.subtitle = element_text(size = 25, margin = margin(t = 15)),
