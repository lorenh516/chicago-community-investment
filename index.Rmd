...
school_data %>% group_by(`SCHOOL ID (R-C-D-T-S)`, predominant_race) %>% 
  ...
  annotate("text", x = 1.15, y = 5, label = "*Keller Gifted Magnet and Sutherland Elementary Schools in the neighboring Mt. Greenwood and Beverly communities on the Far Southwest\nSide have two of the smallest differences between white and non-white student percentages across all non-white schools.", hjust=0, size=rel(7), face="bold")
```
