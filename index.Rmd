...
theme_modest <- function(base_size = 22,
  ...
  theme_minimal(base_size = base_size, 
    ...
    theme(
        ...
        plot.background = element_rect(colour = NA, fill="#fff7ce"),
...
allDatesCount.df %>% 
 ...
 mutate(SIDE_CLEAN = factor(SIDE,levels = rev(unique(SIDE))),
  ...
  theme(legend.position = c(0.6, 0.9),
        ...
        axis.title.x = element_blank(),
        plot.margin = unit(c(2,2,2,2),"lines")) + facet_rep_wrap(~ SIDE_CLEAN, repeat.tick.labels=TRUE) +
