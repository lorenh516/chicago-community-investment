...
```{r}
theme_diverging_green <- function(base_size = 12,
...
rm(wards.shp.2015, wards2015.df, wards2015.points, wards2015)
```
...
ggplot(all.demos.Chi) +
  ...
  facet_wrap( ~ id) + labs(
    ...
    caption = "Source: U.S. Census Bureau", color = "Race"
  )
