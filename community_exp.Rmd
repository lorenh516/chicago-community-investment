...
```{r}
# tidycensus::census_api_key(Sys.getenv("CENSUS_API_KEY"), install=TRUE, overwrite=TRUE)

# want to know: how population changing/ not changing across tracts - race, age, income, poverty status, safety net takeup

demos_17 <- tidycensus::get_acs(geography = "tract", 
              variables = c(medianIncome = 'B19013_001',
                            ...
                            maleChildMedicare = 'C27006_003',
                            maleMedicare = 'C27006_002',
                            femaleChildMedicare = 'C27006_013',
                            femaleMedicare = 'C27006_012',
                            medicaidPop = 'C27007_001',
                            maleChildMedicaid = 'C27007_003',
                            maleMedicaid = 'C27007_002',
                            femaleChildMedicaid = 'C27007_013',
                            femaleMedicaid = 'C27007_012'
                            ), 
              year = 2017,
              state = "IL",
              county = "Cook")
...
```{r}
demos_17 %>% dplyr::select(-one_of("moe")) %>% spread(variable, estimate)
```



```{r}
years <- lst(2013, 2014, 2015, 2016, 2017, 2018)
...
```{r}
v15 <- tidycensus::load_variables(2015, "acs5", cache = TRUE)
View(v15)
```
